...
class IntroImageProjectPage extends StatefulWidget {
  ...
  const IntroImageProjectPage({Key key, this.collectionId, this.beginIndex, this.modelId})
      : super(key: key);
        ...
        child: SizedBox.fromSize(
            ...
            child: FutureBuilder<ImageListViewModel>(
              future: Provider.of<ImageListViewModel>(context, listen: false)
                  .getImageListProject(widget.collectionId, widget.beginIndex, widget.modelId),
